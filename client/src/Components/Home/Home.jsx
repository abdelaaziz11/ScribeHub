      ...
      <div className="home">
        <section className='home_hero'>
          <div className="left_hero">
            <h1>ChatTales</h1>
            <p>Welcome to ChatTales, a vibrant space where stories come to life and communities grow through connection <br />
        ...
        <section className="about">
          ...
          <p className="about-paragraph">
            ...
            🗣 Start private or group chats with other members<br />
